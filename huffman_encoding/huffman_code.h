...
// A utility function to check if size of heap is 1 of not
...
// main function build Huffman tree
...
// print Huffman codes from the root of Huffman Tree. It uses arr[] tp store codes.
